import typing as t
from my_model.VSS2D import VSSM
import torch
...
class SCSA(BaseModule):
    ...
    def __init__(
        ...
        self.ssm = VSSM(in_chans=dim,dims=[dim])
        self.dim = dim
...
def main():
    ...
    model = SCSA(dim=dim, head_num=head_num, window_size=window_size, group_kernel_sizes=group_kernel_sizes).to(device)
